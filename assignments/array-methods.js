...
// Problem 2
//put the company name and donation amount together
let companyDonations = [];
runners.forEach(function(items){
  return companyDonations.push(`${items.company_name}: ${items.donation}`);
});    
console.log(companyDonations);
// Problem 3
//filter all the donations above 100 into a new array
let bigSpenders = [];
